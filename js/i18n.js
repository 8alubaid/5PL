...
export const I18N = {
  ...
  savedErr: { ar:'صار خطأ أثناء الحفظ، حاول مرة ثانية', en:'Something went wrong saving — try again' },
  ...
  editPredictions: { ar:'تعديل توقعاتي', en:'Edit My Predictions' },
  ...
  downloadExcel: { ar:'تنزيل نسخة Excel', en:'Download Excel Backup' },
  ...
  editRound: { ar:'تعديل الجولة', en:'Edit Round' },
  ...
  settingsTitle: { ar:'إعدادات المسابقة', en:'Competition Settings' },
  ...
  storageNotConnected: { ar:'التخزين غير مربوط', en:'Storage not connected' },
  ...
  hankaRelegatedLabel: { ar:'الهابطين', en:'Relegated' },
  ...
  hankaEditBtn: { ar:'تعديل توقعي', en:'Edit My Prediction' },
