...
export const I18N = {
  ...
  tabHanka: { ar:'الحنكة', en:'Al-Hanka' },
  ...
  hankaSaveBtn: { ar:'حفظ توقع الحنكة 💾', en:'Save Al-Hanka Prediction 💾' },
  ...
  hankaSavedTitle: { ar:'✅ توقع الحنكة محفوظ', en:'✅ Your Al-Hanka prediction is saved' },
  hankaEditBtn: { ar:'تعديل توقعي ✏️', en:'Edit My Prediction ✏️' },
  hankaLockedHint: { ar:'🔒 المنظم قفل توقعات الحنكة — ما تقدر تعدلها الحين', en:"🔒 The organizer has locked Al-Hanka predictions — you can't edit yours right now" },
  hankaSavedOk: { ar:'تم حفظ توقع الحنكة ✅', en:'Your Al-Hanka prediction was saved ✅' },
  hankaLockedToast: { ar:'الحنكة مقفلة — ما تقدر تحفظ تعديل الحين', en:"Al-Hanka is locked — you can't save a change right now" },
  hankaAdminTitle: { ar:'إدارة الحنكة 🧠', en:'Manage Al-Hanka 🧠' },
  hankaLockBtn: { ar:'قفل توقعات الحنكة 🔒', en:'Lock Al-Hanka Predictions 🔒' },
  hankaUnlockBtn: { ar:'فتح توقعات الحنكة 🔓', en:'Unlock Al-Hanka Predictions 🔓' },
  ...
  hankaAnswersHint: { ar:'بعد ما تنحسم نتائج الدوري نهاية الموسم، عبّي الإجابات الصحيحة هنا — بمجرد الحفظ، كل اللاعبين بيشوفون نقاط الحنكة وترتيبها.', en:"Once the league's real results are decided at the end of the season, fill in the correct answers here — as soon as you save, every player will see Al-Hanka points and standings." },
  ...
  hankaYourPoints: { ar:'نقاطك بالحنكة', en:'Your Al-Hanka points' },
  hankaStandingsTitle: { ar:'🏅 ترتيب الحنكة', en:'🏅 Al-Hanka Standings' },
